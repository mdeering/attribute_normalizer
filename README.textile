...
p. I like to keep my active record models as strict as possible but I also like the further layer of protection/restriction on the data that setting your database columns to not allow NULL ads to columns where there is going to be a validates_presence_of.
